...
import FloatingRectText from "../components/FloatingRectText";
      ...
      >
        ...
        ">
          ...
          <div className="
            ...
            shadow-[0_0_160px_rgba(139,92,246,0.55)]
            overflow-hidden
            z-20
          ">
            <img
...
function Terminal() {
  return (
    <div className="font-mono text-xs sm:text-sm text-violetGlow space-y-2">
      <p>{">"} whoami</p>
      <p className="text-white">MOHAMMED AADHIL N</p>

      <p className="mt-3">{">"} ls</p>
      <p className="text-white">
        about skills projects experience resume contact
      </p>
    </div>
  );
}
